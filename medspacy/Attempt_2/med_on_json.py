...
for source_name, source_info in data_sources.items():
    ...
    for table_name in source_info["tables"]:
        all_rules.append(TargetRule(literal=table_name, category="Table"))
...
# rules_list.append(TargetRule(literal=""))
...
final_file = r"D:\xcaliber\study\another_try_to_ner\files\another3.json"
